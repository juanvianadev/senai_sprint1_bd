...
INSERT INTO Paciente (IdUsuario, Nome, DataNascimento, Telefone, RG, CPF, CEP, Endereco)
...
INSERT INTO Clinica (Nome, CNPJ, RazaoSocial, HorarioAbertura, HorarioFechamento, Endereco)
...
INSERT INTO Medico (IdUsuario, IdClinica, IdEspecialidade, Nome, CRM, Estado)
...
INSERT INTO Consulta(IdPaciente, IdMedico, IdSituacao, DataAgendamento)
VALUES (16, 3, 2, '20/01/2020  15:00'),
	   (4, 2, 3, '06/01/2020  10:00'),
	   (5, 2, 2, '07/02/2020  11:00'),
	   (4, 2, 2, '06/02/2018  10:00'),
	   (6, 1, 3, '07/02/2019  11:00'),
	   (16, 3, 1, '08/03/2020  15:00'),
	   (6, 1, 1, '09/03/2020  11:00');
GO
